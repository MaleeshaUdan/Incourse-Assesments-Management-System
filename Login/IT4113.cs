...
namespace Login
{
    /*----Here coding contains
        ...
        home   
         ------------------------*/
    public partial class IT4113 : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            if (index!="" && reg !="" && numericText1.Text!="" && numericText2.Text!="" && numericText3.Text!="")
            {
                ...
                if (ic1 >= 0 && ic1 <= 100 && ic2 >= 0 && ic2 <= 100 && ic3 >= 0 && ic3 <= 100)
                {
                    ...
                    cmd.CommandText = "INSERT INTO IT4113 VALUES('" + index + "','" + reg + "','" + ic1 + "','" + ic2 + "','" + ic3 + "')";
                    cmd.ExecuteNonQuery();
                    con.Close();
                    insertDisplay();
        ...
        private void insertDisplay()
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT * FROM IT4113";
            cmd.ExecuteNonQuery();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (index != "" || reg != "")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "DELETE FROM IT4113 WHERE INDEXNUMBER='" + index+"' OR REGNUMBER='"+reg+"'";
                cmd.ExecuteNonQuery();
                con.Close();
                insertDisplay();
        ...
        private void userCounttDisplay()
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT COUNT (*) AS STUDENTS FROM IT4113";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (index!="" || reg!="")
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT * FROM IT4113 WHERE INDEXNUMBER='" + index + "' OR REGNUMBER='" + reg + "'";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
                ...
                if(numericText1.Text!="" || numericText2.Text!="" || numericText3.Text != "")
                {
                    if (numericText1.Text!="")
                    {
                        ...
                        if (ica1 >= 0 && ica1 <= 100)
                        {
                            ...
                            SqlCommand cmd = con.CreateCommand();
                            cmd.CommandType = CommandType.Text;
                            cmd.CommandText = "UPDATE IT4113 SET ICA1='" + ica1 + "'WHERE INDEXNUMBER='" + index + "'OR REGNUMBER='" + reg + "'";
                            cmd.ExecuteNonQuery();
                            con.Close();
                        }
                        else
                    ...
                    if (numericText2.Text != "")
                    {
                        ...
                        if (ica2 >= 0 && ica2 <= 100)
                        {
                            ...
                            SqlCommand cmd = con.CreateCommand();
                            cmd.CommandType = CommandType.Text;
                            cmd.CommandText = "UPDATE IT4113 SET ICA2='" + ica2 + "'WHERE INDEXNUMBER='" + index + "'OR REGNUMBER='" + reg + "'";
                            cmd.ExecuteNonQuery();
                            con.Close();
                        }else
                        {
                    ...
                    if (numericText3.Text != "")
                    {
                        ...
                        if (ica3 >= 0 && ica3 <= 100)
                        {
                            ...
                            SqlCommand cmd = con.CreateCommand();
                            cmd.CommandType = CommandType.Text;
                            cmd.CommandText = "UPDATE IT4113 SET ICA3='" + ica3 + "'WHERE INDEXNUMBER='" + index + "'OR REGNUMBER='" + reg + "'";
                            cmd.ExecuteNonQuery();
                            con.Close();
                        }
                        else
        ...
        private void btnMax_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT MAX(ICA1) AS MAXIMUM FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton2.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT MAX(ICA2) AS MAXIMUM FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton3.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT MAX(ICA3) AS MAXIMUM FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
        ...
        private void btnLow_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT MIN(ICA1) AS LOWEST FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton2.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT MIN(ICA2) AS LOWEST FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton3.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT MIN(ICA3) AS LOWEST FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
        ...
        private void btnAve_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT AVG(ICA1) AS AVERAGE FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton2.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT avg(ICA2) AS AVERAGE FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton3.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT AVG(ICA3) AS AVERAGE FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
        ...
        private void btnTot_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT SUM(ICA1) AS TOTAL FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton2.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT SUM(ICA2) AS TOTAL FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
            ...
            if (radioButton3.Checked)
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT SUM(ICA3) AS TOTAL FROM IT4113";
                cmd.ExecuteNonQuery();
                DataTable dt = new DataTable();
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
